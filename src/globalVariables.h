...
extern volatile bool ADCConversionFlag, LoadChangeFlag, hourHasChanged;
extern volatile uint8_t hourCount , remainingHours;
...
extern volatile uint32_t hourChangeStartTime;
