...
// Utility functions
/**
 * Sends an AT command to the ESP module, reads the response, and extracts data between the specified start and end tags.
 * The extracted string is written to the output buffer.
 * @param cmd The AT command to be sent to the ESP module.
 * @param startTag The string indicating the start of the desired data in the ESP response.
 * @param endTag The string indicating the end of the desired data in the ESP response.
 * @param outStr A buffer to store the extracted data from the ESP response.
 * @param outStrLen The length of the output buffer to ensure no overflow occurs while writing to it.
 * @return true if the data was successfully extracted between startTag and endTag; false otherwise.
 */
